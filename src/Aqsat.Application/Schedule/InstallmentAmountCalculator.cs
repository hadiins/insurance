...
/// <summary>docs/PHASE-1-SPEC.md §3.2: Financed = TotalReceivable (NetPremium + ServiceFee) -
/// DownPayment; base = floor(financed / N); the rounding remainder lands on the last installment,
/// not spread across all of them.</summary>
public static class InstallmentAmountCalculator
{
    public static IReadOnlyList<decimal> CalculateAmounts(decimal totalReceivable, decimal downPayment, int installmentCount)
    {
        ...
        var financed = totalReceivable - downPayment;
