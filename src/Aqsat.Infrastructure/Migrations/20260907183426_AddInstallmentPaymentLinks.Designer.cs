...
namespace Aqsat.Infrastructure.Migrations
{
    ...
    [Migration("20260907183426_AddInstallmentPaymentLinks")]
    partial class AddInstallmentPaymentLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aqsat.Domain.AgencyStatsDaily", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<decimal>("InquiryCallCostToman")
                        .HasPrecision(18)
                        .HasColumnType("decimal(18,0)");

                    b.Property<int>("InquiryCallsCount")
                        .HasColumnType("int");

                    b.Property<int>("InquiryPaymentsCount")
                        .HasColumnType("int");

                    b.Property<decimal>("InquiryRevenueToman")
                        .HasPrecision(18)
                        .HasColumnType("decimal(18,0)");
                    ...
                    b.Property<decimal>("SmsCostToman")
                        .HasPrecision(18)
                        .HasColumnType("decimal(18,0)");
                    ...
                    b.HasIndex("AgencyId", "StatDate")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("AgencyStatsDaily");
                });
            ...
            modelBuilder.Entity("Aqsat.Domain.Bank", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Aqsat.Domain.CommissionPayout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Aqsat.Domain.CreditReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<decimal?>("ChequeSumAmountToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("ChequeSumBouncedAmountToman")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("LoanDebtTotalAmountToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("LoanDeferredTotalAmountToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("LoanDishonoredAmountToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("LoanPastExpiredTotalAmountToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("LoanSuspiciousTotalAmountToman")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Aqsat.Domain.CustomerPortalInvitation", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AgencyDecisionAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid?>("AgencyDecisionByUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("CustomerApprovedAtUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<decimal?>("DownPaymentAmountToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTimeOffset?>("DownPaymentPaidAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset>("ExpiresAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<decimal>("InquiryFeeToman")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<decimal?>("PaidAmountToman")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("CustomerPortalInvitations");
                });
            ...
            modelBuilder.Entity("Aqsat.Domain.FundTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("AgencyId", "FromBankAccountId");

                    b.HasIndex("AgencyId", "FromCashBoxId");

                    b.HasIndex("AgencyId", "ToBankAccountId");

                    b.HasIndex("AgencyId", "ToCashBoxId");
            ...
            modelBuilder.Entity("Aqsat.Domain.OrgSettings", b =>
                {
                    ...
                    b.Property<string>("AgentMerchantId")
                        .HasMaxLength(128)
                    ...
                    b.Property<string>("DangerZoneManagerMobile")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("InstallmentContractText")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("PortalInvitationTtlHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aqsat.Domain.PlatformPaymentSettings", b =>
                {
                    ...
                    b.Property<string>("OwnerMerchantId")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Aqsat.Domain.PortalInvitationTokenIndex", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("PortalInvitationTokenIndex");
                });
            ...
            modelBuilder.Entity("Aqsat.Domain.FundTransfer", b =>
                {
                    b.HasOne("Aqsat.Domain.BankAccount", "FromBankAccount")
                        .WithMany()
                        .HasForeignKey("FromBankAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Aqsat.Domain.CashBox", "FromCashBox")
                        .WithMany()
                        .HasForeignKey("FromCashBoxId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Aqsat.Domain.BankAccount", "ToBankAccount")
                        .WithMany()
                        .HasForeignKey("ToBankAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Aqsat.Domain.CashBox", "ToCashBox")
                        .WithMany()
