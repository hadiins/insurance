...
public sealed class AgencyCommissionEntryConfiguration : AqsatEntityConfiguration<AgencyCommissionEntry>
{
    public override void Configure(EntityTypeBuilder<AgencyCommissionEntry> builder)
    {
